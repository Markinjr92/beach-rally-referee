-- Add direct_win_format column to matches table
...
COMMENT ON COLUMN public.matches.direct_win_format IS 'Formato de pontuação: true = vai a 3 direto, false = vai a 2 tradicional (padrão)';
